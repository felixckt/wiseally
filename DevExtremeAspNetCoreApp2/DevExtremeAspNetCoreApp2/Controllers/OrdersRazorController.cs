...
namespace DevExtremeAspNetCoreApp2.Controllers
{
    ...
    public class OrdersRazorController : Controller
    {
        private DevExtremeAspNetCoreApp2Context _context;

        public OrdersRazorController(DevExtremeAspNetCoreApp2Context context) {
            _context = context;
        }
